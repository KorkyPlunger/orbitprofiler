...
OrbitDiffDialog::~OrbitDiffDialog()
{
    delete ui;
}
...
{
    QString file = QFileDialog::getOpenFileName( this, "Specify an external Diff executable...", "", "*.exe" );
...
{
    Diff::Exec(ui->plainTextEdit->toPlainText().toStdString(), ui->plainTextEdit_2->toPlainText().toStdString());
}
