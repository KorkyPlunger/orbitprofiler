...
OrbitTreeItem *OrbitTreeItem::child(int row)
{
    return m_childItems.value(row);
}

int OrbitTreeItem::childCount() const
{
    return m_childItems.count();
}

int OrbitTreeItem::columnCount() const
{
...
OrbitTreeItem *OrbitTreeItem::parentItem()
{
    return m_parentItem;
}
